            ...
            <div className="bg-white p-6 rounded shadow">
                ...
                <div className="flex gap-3 mb-5">
                    ...
                    <button
                        ...
                        className={`cursor-pointer px-4 py-2 rounded ${filterStatus === "Pending" ? "bg-orange-500 text-white" : "bg-gray-200"}`}
                    >
                        Pending
                    </button>
                    <button
                        onClick={() => setFilterStatus("Approved")}
                        className={`cursor-pointer px-4 py-2 rounded ${filterStatus === "Approved" ? "bg-green-600 text-white" : "bg-gray-200"}`}
                    >
                        Approved
                    </button>
                    <button
                        onClick={() => setFilterStatus("Rejected")}
                        className={`cursor-pointer px-4 py-2 rounded ${filterStatus === "Rejected" ? "bg-red-600 text-white" : "bg-gray-200"}`}
                    >
                        Rejected
                    </button>
                </div>
